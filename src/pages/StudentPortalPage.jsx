...
          <Button variant="primary" size="sm" iconName="computer" onClick={() => window.open('https://student-portal-peach-eight.vercel.app/', '_blank')}>Code-to-design</Button>
...
            variant="primary" 
            iconName="computer" 
            onClick={() => window.open('https://student-portal-peach-eight.vercel.app/', '_blank')}
          >
            Design-to-code
          </Button>
        </div>
